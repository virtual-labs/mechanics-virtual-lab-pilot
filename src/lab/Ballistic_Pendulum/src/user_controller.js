(function() {
	...
	function UserController($mdSidenav, $mdBottomSheet, $log, $q, $scope, $element, Fullscreen, $mdToast, $animate) {
		...
		$scope.mass = 300;/**Initial value for block mass slider*/
		$scope.bullet_mass=3;/**Initial value for bullet mass slider*/
		$scope.velocity=50;/**Initial value for velocity slider*/
		$scope.velocity_max=250;/**Final value for velocity slider*/
