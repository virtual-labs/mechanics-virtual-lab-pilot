...
var alpha, gravity, mass_of_flywheel, diameter_of_flywheel, mass_of_rings;

var diameter_of_axle, no_of_wound, rolling, INTERVAL, angular_velocity, angular_distance;

var total_rotation, number_of_rotation, clr_string_intrl;

var line_mask, weight_obj, play_event, final_rotation;

var string_x_pos, itration, x_decrement, moment_of_inertia_of_flywheel, wheel_rotation_speed;

var rotation, rotation_decimal, last_rotation_angle, reset_flag;
...
function directiveFunction(){
    return {
        ...
        link: function(scope, element,attrs){
            ...
            weight_container_temp = new createjs.Container();/** Creating new container to keep weights together while the weights falls from flywheel*/
            ...
            function handleComplete(){  /** Loading all preloaded images to canvas */               
                ...
                drawLine(); /** Function to draw lines over flywheel*/
            ...
            function translationLabels(){
                ...
                scope.heading=_("Torque and Angular Acceleration of a Flywheel");
                ...
                scope.mass_of_fly_wheel_lbl = _("Mass of flywheel:");
                scope.dia_of_fly_wheel_lbl = _("Diameter of flywheel:");
                ...
                scope.mInertia_val = "";
                btn_lbls = [_("Release flywheel"),_("Hold flywheel")];
...
function initialisationOfControls(scope){
    ...
    scope.btn_disabled = false; /** Variable to disable 'Release flywheel' button */
    scope.mInertia_val = 0.0063;
}
/** All variables initialising in this function */
function initialisationOfVariables() {
    gravity = 9.8; /** Initial graviational value of environmetn */
    mass_of_flywheel = 5; /** Initial mass of flywheel */
    diameter_of_flywheel = 10; /** Initial diameterof flywheel */
    mass_of_rings = 200; /** Initial mass of hanging weight */
    diameter_of_axle = 2; /** Initial diameter of axl of flywheel */
    no_of_wound = 1; /** Initial number of wounds on flywheel */
    rotation_speed = wheel_rotation_speed = 33600/4; /** Initially speed rate of flywheel in milli seconds */
    speed_correction = 2.0001; /** Speed correction value for adjusting the speed of flywheel */
    ...
    wound = new createjs.Shape(); /** Shape object to create wound over axl of flywheel */
    string_x_pos = 0; /** Initial position of string wounded over axl of flywheel */
    ...
    rolling = false; /** Variable to indicate that strating of flywheel rotation, and it used to differentiate initial wheel rotation and wheel rotation after pause */
    INTERVAL = 0.2; /** Basic time interval of simulation(200 milli second) */
    total_rotation = 360; /** One roation of flywheel */
